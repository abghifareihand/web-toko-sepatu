...
class OrderService
{
    ...
    public function __construct(ShoeRepositoyInterface $shoeRepository, CategoryRepositoyInterface $categoryRepository, PromoCodeRepositoyInterface $promoCodeRepository, OrderRepositoyInterface $orderRepository)
    {
