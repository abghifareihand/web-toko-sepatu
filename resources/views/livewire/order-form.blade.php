        ...
        <div class="flex flex-col rounded-[20px] p-4 mx-4 pb-5 gap-5 bg-white">
            <div id="info" class="flex items-center justify-between">
                <div class="flex flex-col">
                    <h1 id="title" class="font-bold text-[22px] leading-[30px]">{{ $shoe->name }}
                    </h1>
                    <p class="font-semibold text-lg leading-[27px]">Rp
                        {{ number_format($shoe->price, 0, ',', '.') }} • {{ $orderData['shoe_size'] }}</p>
                </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <p id="total-price" class="font-bold">Rp
                    {{ number_format($subTotalAmount, 0, ',', '.') }}</p>
            </div>
            <div class="flex items-center justify-between">
                <p class="font-semibold">Discount</p>
                <p id="discount" class="font-bold text-[#FF1943]">- Rp
